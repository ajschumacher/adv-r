...
* Create a table that has _add_, _multiply_, _smaller_, _larger_, _and_, and _or_ in the columns and _binary operator_, _reducing variant_, _vectorised variant_, _array variants_ in the rows.
